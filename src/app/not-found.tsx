    ...
    <div className="flex min-h-dvh items-center justify-center px-4 sm:px-6">
      <RevealOnMount>
        <div className="neu-raised max-w-md px-6 py-10 text-center sm:px-10 sm:py-12">
          <p className="font-(family-name:--font-display) text-6xl italic text-(--color-accent-strong)">404</p>
          <h1 className="mt-4 text-xl font-medium text-(--color-text-primary)">Page not found</h1>
